"""
Builds a parcel-level CSV with assessor attributes.
...
The final output has one row per parcel geometry and includes parcel geometry
in WKT format.

Inputs:
- `boston_parcel_assessors.csv`
